---
title: We Have Pixels!
date: 2021-01-06
category: How-to
tags:
- hardware
- pixels
media_subpath: /assets/img/posts/we-have-pixels/
image:
    path: preview.jpg
    lqip: preview.lqip.jpg
---

So, not long after I'd designed the [layout I thought I'd be happy with][1] in xLights, I went ahead and ordered the pixels. This can be an interesting task, so I'll walk through what I did.
...
![second caveat?](caveat.jpg){: lqip="caveat.lqip.jpg" }
...
![chromatrim](chromatrim.jpg){: lqip="chromatrim.lqip.jpg" }
_Chromatrim, semi-rigid mounting at 1" spacing in 4' strips (Boscoyo Studio)_

![megatree roll](megatree-roll.jpg){: lqip="megatree-roll.lqip.jpg" }
_Megatree Roll, 1" spacing, flexible so you can just roll up the lights after the season (Boscoyo Studio)_
...
![Banana for scale](banana-for-scale.jpg){: lqip="banana-for-scale.lqip.jpg" }
_Ten 500 pixel bags_
...
![ray wu item shipping](ray-wu-order.jpg){: lqip="ray-wu-order.lqip.jpg" }
_Shipping cost ain't no joke; $16 for a $5 item_
