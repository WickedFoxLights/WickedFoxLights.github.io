...
- hardware
- props
media_subpath: /assets/img/posts/permanent-roofline-lights/
image:
    path: preview.jpg
    lqip: preview.lqip.jpg
---

(Originally published May, 2022; updated with info since then)

When we got into the new house, redesigning basically the entire display was going to be necessary. It's a bit of a bummer that this had to be done so soon after designing the last display, but an evolving display was always in the cards, so that evolution just happened a bit more aggressively!
...
I'd been reading a bunch about various different methods of installing permanent lights on the roofline, so lots of different thoughts and approaches. However, three were really worth considering, in my opinion.
...
![led strip](led-strip.jpg){: lqip="led-strip.lqip.jpg" }
_credit: Derun LED Lights_
...
been working perfectly for the last 4 years.

{% include embed/youtube.html id='8bfnZr51zZc' %}

Overall, I'm really happy with the design; it blends in very nicely, and has been the most solid part
of my entire light show; haven't had any problems with any of it. But now that everyone is getting those Govee
lights in their eaves, I can say that I did it first :-p